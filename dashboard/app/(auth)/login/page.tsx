    ...
    <div className="font-mono text-aergus-text min-h-screen flex items-center justify-center bg-aergus-bg p-4 md:p-8 overflow-hidden select-none">
      ...
      <div className="w-full max-w-5xl bg-aergus-card border border-aergus-border rounded-none shadow-2xl relative">
        <div className="flex flex-col lg:flex-row w-full min-h-[540px]">
          ...
          <div
            className={`w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-between tech-hatch-bg transition-transform duration-500 ease-in-out transform ${mode === "register"
          ...
          <div
            className={`w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-between bg-aergus-card transition-transform duration-500 ease-in-out transform ${mode === "register" ? "lg:-translate-x-full" : ""
              }`}
          >
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  {mode === "login" && (
                    <Button
                      ...
                      className="text-[11px] text-aergus-text-dim hover:text-aergus-primary no-underline"
                    >
                      Forgot Password
                    </Button>
                  )}
                ...
                <Button
                  type="submit"
                  disabled={submitting}
                  className="w-full h-11 btn-chamfer mt-3 shadow-lg disabled:opacity-50"
                >
                  {submitting
                    ? "PROCESSING..."
                    : mode === "register"
              ...
              {mode === "login" ? (
                <>
                  ...
                  <Button
                    ...
                    className="text-aergus-primary font-bold hover:underline no-underline ml-1"
                  >
                    Sign up
                  </Button>
                </>
